function [FO1_0 FA1_0 FA2_0 FA3_0 FO3_0 ] = morequickreturn(t,x);
...
q01_0(1:3,1) = x(i,10:12);% rO1_0_0.
pl1_0(1:3,1) = x(i,13:15);% translational momentum of link 1.
pl1_C1_0(1:3,1) = x(i,16:18);% angular momentum of link 1 about C1 expressed in frame 0.
rC1_0_0(1:3,1) = x(i,19:21);% position of CM of link 1, C1, wrt 0 expressed in frame 0.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%% link 2 %%%%%%%%%%%%%%%%%%%%
R2_0(:,1) = x(i,22:24);
R2_0(:,2) = x(i,25:27);
R2_0(:,3) = x(i,28:30);
q12_0(1:3,1) = x(i,31:33);
pl2_0(1:3,1) = x(i,34:36);% translational momentum of link 2.
pl2_C2_0(1:3,1) = x(i,37:39);% angular momentum of link 2 about C2 expressed in frame 0.
rC2_0_0(1:3,1) = x(i,40:42);% position of CM of link 2, C2, wrt 0 expressed in frame 0.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%link 3%%%%%%%%%%%%%%%%%%%%%%%%%
R3_0(:,1) = x(i,43:45);
R3_0(:,2) = x(i,46:48);
R3_0(:,3) = x(i,49:51);
q03_0(1:3,1) = x(i,52:54);
pl3_0(1:3,1) = x(i,55:57);% translational momentum of link 3.
pl3_C3_0(1:3,1) = x(i,58:60);% angular momentum of link 3 about C3 expressed in frame 0.
rC3_0_0(1:3,1) = x(i,61:63);% position of CM of link 3, C3, wrt 0 expressed in frame 0.
q3C_3(1:3,1) = x(i,64:66);
q23r_0(1:3,1) = x(i,67:69);
qc_0(1:3,1)=x(i,70:72);
%%%%%%%%link 4%%%%%%%%%%%%%
R4_0(:,1) = x(i,73:75);
R4_0(:,2) = x(i,76:78);
R4_0(:,3) = x(i,79:81);
q34_0(1:3,1) = x(i,82:84);
pl4_0(1:3,1) = x(i,85:87);
pl4_C4_0(1:3,1) = x(i,88:90);
rC4_0_0(1:3,1) = x(i,91:93);
%%%%%%%%%%%%%%link5%%%%%%%%%%%%%
R5_0(:,1) = x(i,94:96);
R5_0(:,2) = x(i,97:99);
R5_0(:,3) = x(i,100:102);
q45_0(1:3,1) = x(i,103:105);
q5C_0(1:3,1) = x(i,106:108);
pl5_0(1:3,1) = x(i,109:111);
pl5_C5_0(1:3,1) = x(i,112:114);
rC5_0_0(1:3,1) = x(i,115:117);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
FA2_0(1:3,i) = -( eq12_0 + eR12_0 );
FA1_0(1:3,i) = - FA2_0(1:3,i); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%link 3%%%%%%%%%%%%%%%%%%%%%
...
FA3_0(1:3,i) = -R3_0*(-eq3C_3 - eR3C_3 );
FO3_0(1:3,i) = eqO3_0 + eR03_0;
...
dpl1_0 = eqO1_0 + eR01_0 + FA1_0(1:3,i) + m1g;%with gravitational force

%torque1 = [0 0 2]';%[0 0 .2*(1- 2.73.^(-t/10))]';%[0 0 0]';%no torque%
dpl1_C1_0 = Tc+ rO1_C1_0X * (eqO1_0 + eR01_0) + rA1_C1_0X * FA1_0(1:3,i);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%% link 2 %%%%%%%%%%%%%%%%%%%%
dR2_0 = w2_0_0X * R2_0;

dpl2_0 = - FA3_0(1:3,i) + FA2_0(1:3,i) + m2g;%with gravitational force

dpl2_C2_0 = rA2_C2_0X * FA2_0(1:3,i) + eq23r_0 + eR23r_0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%% link 3 %%%%%%%%%%%%%%%%%%%%
dR3_0 = w3_0_0X * R3_0;

dpl3_0 = FA3_0(1:3,i) + FO3_0(1:3,i) +  FA33_0+ m3g;

dpl3_C3_0 =  rA33_C3_0X*FA33_0 +rA3_C3_0X * FA3_0(1:3,i) + rO3_C3_0X * FO3_0(1:3,i) - eq23r_0 - eR23r_0;
...
[FO1_0 FA1_0 FA2_0 FA3_0 FO3_0 ]; %= dx;%Output of the ODE file quickreturnode.m, function quickreturnode
